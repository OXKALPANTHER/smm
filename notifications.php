...
<div class="container py-4" style="max-width: 720px;">
  <div class="d-flex justify-content-between align-items-center mb-3 gap-2 flex-wrap">
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
      <a href="index.php" class="btn btn-sm btn-outline-primary rounded-pill"><i class="bi bi-house-door-fill"></i> Dashboard</a>
  ...
  <div class="d-flex flex-wrap gap-2 mb-3">
    <?php if ($unreadCount > 0): ?>
      <form method="post" class="d-inline">
        ...
        <button class="btn btn-sm btn-outline-primary rounded-pill"><i class="bi bi-check2-all"></i> Weka zote zimesomwa</button>
      </form>
    <?php endif; ?>
          ...
          <div class="border rounded-4 p-3 <?= ($n['status'] ?? 'unread') === 'unread' ? 'border-primary' : '' ?>" style="background: <?= ($n['status'] ?? 'unread') === 'unread' ? '#f7f9ff' : '#ffffff' ?>;">
            ...
            <div class="d-flex flex-wrap gap-2 mt-3">
              ...
              <form method="post" class="d-inline">
                ...
                <input type="hidden" name="id" value="<?= (int)$n['id'] ?>">
                <button class="btn btn-sm btn-outline-danger rounded-pill"><i class="bi bi-trash"></i> Futa</button>
              </form>
            </div>
          </div>
        <?php endforeach; ?>

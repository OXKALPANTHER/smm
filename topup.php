<?php
// Performance direction: preserve the payment workflow while serving precompiled styles instead of compiling CSS in the browser.
...
<head>
    ...
    <link rel="stylesheet" href="assets/topup-tailwind.css">
